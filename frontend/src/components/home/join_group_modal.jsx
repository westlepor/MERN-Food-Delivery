...
import { faUsers, faExternalLinkAlt, faPhone, faDirections } from "@fortawesome/free-solid-svg-icons";
// import { faYelp } from "@fortawesome/free-regular-svg-icons";
...
render(){
          ...
          //https://www.google.com/maps/search/?api=1&query=this.props.topThree.first.latitude,this.props.topThree.first.longitude
